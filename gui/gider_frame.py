...
class GiderFrame(tk.Frame):
    def __init__(self, parent, finans):
        super().__init__(parent)
        self.finans = finans

        baslik = tk.Label(self, text="Gider Ekle", font=("Arial", 16, "bold"))
        baslik.pack(pady=10)
        ...
        tk.Button(self, text="Gider Ekle", command=self.gider_ekle).pack(pady=10)
    ...
    def gider_ekle(self):
        ...
        self.finans["gider"].append(gider)
